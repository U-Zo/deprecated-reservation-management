    ...
    function cbmc_book() {
        ...
        if (in_array($this->data['Reservation']['cat_id'], $this->hotelCategory)) {
            ...
            for ($i = 0; $i < $paxNum; $i++) {
                ...
                $this->loadModel("CbmcOptions");
                $this->data['CbmcOptions']['tour'] = $this->data['CbmcCustomers']['tour0'];
                $this->data['CbmcOptions']['profile_id'] = $this->Profile->id;
                $this->CbmcOptions->save($this->data);
                $profile_id = '';
                $org_profile = '';
                //echo $profile_id;
                //echo $org_profile;
            ...
            $this->data['Reservation']['total'] = $this->data['CbmcReservations']['price'];
