...
class ReservationsController extends AppController
{
    ...
    function beforeFilter()
    {
        parent::beforeFilter();
        $this->layout = 'default';
        $this->Auth->allowedActions = array('cbmc', 'cbmc_en', 'cbmc_book', 'kcbmc_book', 'cbmc_find');
        //$this->layout = 'sub_L';
    }
    ...
    function cbmc()
    {
        ...
        $notice = $this->CbmcText->find('first');
        ...
        if (in_array($this->data['Reservation']['cat_id'], $this->hotelCategory)) {
            ...
            for ($i = 0; $i < $paxNum; $i++) {
                ...
                if (!$this->data['Profile']['id']) {
                    ...
                    $this->data['Cbmc']['kakao'] = $this->data['Cbmc']['kakao' . $i];
                    $this->data['Cbmc']['title'] = $this->data['Cbmc']['title' . $i];
                    $this->data['Cbmc']['korean_name'] = $this->data['Cbmc']['korean_name' . $i];
                    if ($this->data['Cbmc']['hotel'] == 0) {
                        $this->data['Cbmc']['check_in'] = "";
                        $this->data['Cbmc']['check_out'] = "";
                        $this->data['Reservation']['room'] = "";
                        $this->data['Reservation']['room_types'] = "";
                    }
